...
function PremiumFollowPage() {
  return (
		<div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
			<h1 className="title text-center mb-12">Support your favorite artist</h1>
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-4 sm:items-center max-w-6xl">
				<article className="relative cursor-pointer overflow-hidden rounded-lg shadow transition hover:shadow-lg w-64">
					<img
						alt="Office"
						src="/charlie-puth.jpg"
					...
					<div className="relative bg-gradient-to-t from-gray-900/50 to-gray-900/25 pt-32 sm:pt-48 lg:pt-64">
						<div className="p-4 sm:p-6">
							<a href="#">
								<h3 className="mt-0.5 text-lg text-white">Charlie Puth</h3>
							</a>
...
export default PremiumFollowPage